function pageLoad() {
    ...
    var confirmMyInput = document.getElementById("conpword");
    ...
    myInput.onkeyup = function () {
      ...
      var numbers = /\d/; // Fill in the regular expression for digits
      var symbols = /\W/; // Fill in the regular expression for symbols
